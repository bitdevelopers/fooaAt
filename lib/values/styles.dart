...
class Styles {
  static TextStyle textBlackSplachScreen = const TextStyle(
      ...
      fontSize: 22);
  static TextStyle textGreenSplachScreen = const TextStyle(
      color: Color.fromRGBO(
        84,
        175,
        118,
      ...
      fontSize: 22);
  static TextStyle textGreySplachScreen = const TextStyle(
      color: Color.fromRGBO(
        154,
        154,
        154,
  ...
  static TextStyle hintGrey12 = const TextStyle(
      color: Color.fromRGBO(
        144,
        144,
        144,
